<?php
function wp63_cpt_order() {
	$labels = array(
		'name'                  => _x( 'คำสั่งโรงเรียน', 'Post Type General Name', 'dsr' ),
		'singular_name'         => _x( 'คำสั่งโรงเรียน', 'Post Type Singular Name', 'dsr' ),
		'menu_name'             => __( 'คำสั่งโรงเรียน', 'dsr' ),
		'name_admin_bar'        => __( 'คำสั่งโรงเรียน', 'dsr' ),
	...
	$args = array(
		'label'                 => __( 'คำสั่งโรงเรียน', 'dsr' ),
		'description'           => __( 'คำสั่งโรงเรียน', 'dsr' ),
		'labels'                => $labels,
