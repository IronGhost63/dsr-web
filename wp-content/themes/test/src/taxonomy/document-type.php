<?php
function wp63_tax_document_type() {

	$labels = array(
		'name'                       => _x( 'Categories', 'Taxonomy General Name', 'dsr' ),
		'singular_name'              => _x( 'Category', 'Taxonomy Singular Name', 'dsr' ),
		'menu_name'                  => __( 'Category', 'dsr' ),
	...
	register_taxonomy( 'doctype', array( 'documents' ), $args );
