					...
					<div class="personel-list container">
						...
						<div class="row personel-list-item">
							...
							<div class="col-md-9">
								...
								<p class="personel-phone">โทรศัพท์ <?php the_field('phone'); ?></p>
								<?php endif; ?>
								<?php if( get_field('email') ) : ?>
								<p class="personel-email">อีเมล <?php the_field('email'); ?></p>
								<?php endif; ?>
							</div>
						</div>
						<div class="row personel-list-head">
						...
						<div class="row personel-list-item">
							...
							<div class="col-md-9">
								...
								<p class="personel-phone">โทรศัพท์ <?php the_sub_field('phone'); ?></p>
								<?php endif; ?>
								<?php if( get_sub_field('email') ) : ?>
								<p class="personel-email">อีเมล <?php the_sub_field('email'); ?></p>
								<?php endif; ?>
							</div>
						</div>
						<?php endwhile; endif; ?>
