<?php
function wp63_cpt_congratulate() {
	
		$labels = array(
			'name'                  => _x( 'ทำเนียบคนเก่ง', 'Post Type General Name', 'dsr' ),
			'singular_name'         => _x( 'ทำเนียบคนเก่ง', 'Post Type Singular Name', 'dsr' ),
			'menu_name'             => __( 'ทำเนียบคนเก่ง', 'dsr' ),
			'name_admin_bar'        => __( 'ทำเนียบคนเก่ง', 'dsr' ),
		...
		register_post_type( 'congratulate', $args );
